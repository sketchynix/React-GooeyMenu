...
},{"./emptyFunction":115,"ngpmcQ":1}],"b6Dds6":[function(require,module,exports){
...
MenuItem = React.createClass({displayName: "MenuItem",
    propTypes: {
    ...
    render() {
        ...
        return (
            ...
            React.createElement("li", {className: "menu-item", style: itemStyle, ref: "menuItem"}, 
                React.createElement("button", {className: "menu-item-button", onMouseDown: this.toggleIcon, ref: "button"}, 
                    React.createElement("i", {className: itemIconClass})
                ), 
                React.createElement("div", {className: "menu-item-bounce", ref: "bounce"})
            )
            /*jshint ignore:end */
        );
    }
        ...
        return (
            React.createElement("div", {className: "menu"}, 
                React.createElement("div", {className: "menu-wrapper"}, 
                    ...
                    React.createElement("button", {className: "menu-toggle-button", onMouseDown: this.toggleIcon, onMouseUp: this.tweenIconUp}, 
                        React.createElement("i", {className: "fa fa-plus menu-toggle-icon", ref: "toggleIcon"})
                    )
                )
            )
        );
